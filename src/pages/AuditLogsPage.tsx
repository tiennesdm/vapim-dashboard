  ...
  const fetch = useCallback(async () => {
    ...
    try {
      ...
      const supplemental: AuditLog[] = [
        ...
        { id: 'audit-18', timestamp: '2025-05-10T16:30:00Z', user: 'admin', action: 'UPDATE user', entityType: 'User', entityId: 'user-7', deails: 'Disabled anna_viewer account', ipAddress: '192.168.1.1' },
