...
export default function Home() {
  ...
  return (
    <Layout>
      ...
      {/* Filter Bar */}
      <div className="flex flex-wrap items-center gap-3 py-4 border-b border-[#3D434F50]">
        {/* Search */}
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="bg-[#1E2128]">
                  ...
                  <th className="px-4 py-3 text-[12px] font-semibold text-[#9DA5B4] uppercase tracking-[0.05em] w-28">Rating</th>
                  <th className="px-4 py-3 text-[12px] font-semibold text-[#9DA5B4] uppercase tracking-[0.05em] w-28">Subscribers</th>
                  <th className="px-4 py-3 text-[12px] font-semibold text-[#9DA5B4] uppercase tracking-[0.05em] w-36">Last Updated</th>
...
function TableRow({
  ...
  return (
    ...
    >
      ...
      <td className="px-4 py-3 text-[13px] text-[#9DA5B4]">
