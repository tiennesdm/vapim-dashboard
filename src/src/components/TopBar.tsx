...
export default function TopBar() {
  ...
  return (
    <header className="fixed top-0 left-[260px] right-0 h-14 bg-[#1A1D23] border-b border-[#3D434F] z-50 flex items-center px-6 gap-6">
      {/* Breadcrumbs */}
      <div className="flex items-center gap-2 text-[13px] flex-shrink-0">
        <Link to="/" className="text-[#6B7280] hover:text-[#E8ECF1] transition-colors">
      ...
      <div className="flex items-center gap-2 flex-shrink-0">
        ...
        <button className="w-8 h-8 flex items-center justify-center rounded-md text-[#9DA5B4] hover:bg-[#353942] hover:text-[#E8ECF1] transition-colors">
          <HelpCircle className="w-[18px] h-[18px]" />
        </button>
        <button className="flex items-center gap-2 ml-2 pl-2 border-l border-[#3D434F]">
